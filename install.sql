...
--
-- Table structure for table `fa_unishop_address`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_address` (
  `id` int(10) NOT NULL,
...
--
-- Table structure for table `fa_unishop_ads`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_ads` (
  `id` int(10) NOT NULL,
  `image` varchar(255) DEFAULT NULL COMMENT '图片',
  `product_id` int(10) DEFAULT NULL COMMENT '产品id',
  `background` varchar(20) NOT NULL COMMENT '背景色',
  `position` int(10) DEFAULT NULL COMMENT '位置',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否显现',
  `weigh` int(10) NOT NULL DEFAULT '0' COMMENT '权重',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='广告图管理';

--
-- Dumping data for table `fa_unishop_ads`
--

INSERT INTO `__PREFIX__unishop_ads` (`id`, `image`, `product_id`, `background`, `position`, `status`, `weigh`, `createtime`, `updatetime`) VALUES
(1, 'http://cdn.shop.weivee.com/shop/20200409/a9d9fb61a0e8047f1d1408ab15f4f51e.png', 8, 'rgb(203, 87, 60)', 0, 1, 1, 1561122209, 1586446660),
(2, 'http://cdn.shop.weivee.com/shop/20200409/272e1e218ee6c8e110032b9c263a3726.png', 9, 'rgb(205, 215, 218)', 0, 1, 2, 1561122255, 1586446648),
(3, 'http://cdn.shop.weivee.com/shop/20200409/e74cb2f3a30013df36805e89b8fcb496.jpeg', 11, 'rgb(183, 73, 69)', 0, 1, 3, 1561122284, 1586446293);

-- --------------------------------------------------------

--
-- Table structure for table `fa_unishop_area`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_area` (
...
--
-- Dumping data for table `fa_unishop_area`
--

INSERT INTO `__PREFIX__unishop_area` (`id`, `pid`, `shortname`, `name`, `mergename`, `level`, `pinyin`, `code`, `zip`, `first`, `lng`, `lat`) VALUES
...
--
-- Table structure for table `fa_unishop_cart`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_cart` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `product_id` int(10) NOT NULL COMMENT '产品id',
  `spec` varchar(50) DEFAULT NULL COMMENT '规格值',
  `number` int(10) UNSIGNED NOT NULL COMMENT '数量',
  `snapshot` text NOT NULL COMMENT '产品快照',
  `choose` tinyint(1) DEFAULT '1' COMMENT '是否选中',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间'
...
--
-- Table structure for table `fa_unishop_category`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_category` (
...
--
-- Dumping data for table `fa_unishop_category`
--
...
(43, 0, 'product', '女士', 'WOMEN', 'index', 'http://cdn.shop.weivee.com/shop/20200406/086a7eb84609aeb6218cbd31b1788384.png', '', '', '', 1582456695, 1586155906, 43, 'normal'),
(44, 0, 'product', '男士', 'MAN', 'index', 'http://cdn.shop.weivee.com/shop/20200406/e4a7970a7cc1ddef74d07965135a5c15.png', '', '', '', 1582456707, 1586155919, 44, 'normal'),
(45, 0, 'product', '儿童', 'CHILDREN', 'index', 'http://cdn.shop.weivee.com/shop/20200406/da346e5d636874fcb41702320796a39d.png', '', '', '', 1582456725, 1586155932, 45, 'normal'),
(46, 0, 'product', '鞋和包', 'Shoes and bags', 'index', 'http://cdn.shop.weivee.com/shop/20200406/58085483723dabedfd66d4f105b30d1d.png', '', '', '', 1582456756, 1586155944, 46, 'normal'),
(47, 46, 'product', '女士', 'Lady', '', 'http://cdn.shop.weivee.com/shop/20200406/cc1a119874b3ce3fe620b247916a51e0.png', '', '', '', 1583764127, 1586157696, 47, 'normal'),
(48, 46, 'product', '男士', 'Man', '', 'http://cdn.shop.weivee.com/shop/20200406/77dca8e429ad40c05254eb3fc2f52941.png', '', '', '', 1583766695, 1586157667, 47, 'normal'),
(49, 46, 'product', '儿童', 'Children', '', 'http://cdn.shop.weivee.com/shop/20200406/4e401d8f429ff5080fbaa23397309920.png', '', '', '', 1583766739, 1586157679, 47, 'normal'),
(50, 45, 'product', '男童', 'Boy', '', 'http://cdn.shop.weivee.com/shop/20200406/2e843f316110a3362e6af1c3ce8f4885.png', '', '', '', 1584279125, 1586157634, 50, 'normal'),
(51, 45, 'product', '女童', 'Girl', '', 'http://cdn.shop.weivee.com/shop/20200406/6b1c283a584350338bc8719cd1ac8d38.png', '', '', '', 1584279143, 1586157645, 51, 'normal'),
(52, 44, 'product', '大衣和风衣', '大衣和风衣', '', 'http://cdn.shop.weivee.com/shop/20200406/00a2fb67c52427ac82c778704cbda2a4.png', '', '', '', 1584279340, 1586157364, 52, 'normal'),
(53, 44, 'product', '夹克外套', '夹克外套', '', 'http://cdn.shop.weivee.com/shop/20200406/ab2cd32e6ef8f8cf0477eadd8a3387e8.png', '', '', '', 1584279445, 1586157387, 53, 'normal'),
(54, 44, 'product', '休闲西装', '休闲西装', '', 'http://cdn.shop.weivee.com/shop/20200406/bac157f7c7681c59e3ec4247ff5fdcab.png', '', '', '', 1584279445, 1586157401, 54, 'normal'),
(55, 44, 'product', '西服套装', '西服套装', '', 'http://cdn.shop.weivee.com/shop/20200406/7f2a4995799cf451188a88c4c13249d0.png', '', '', '', 1584279445, 1586157412, 55, 'normal'),
(56, 44, 'product', '针织衫', '针织衫', '', 'http://cdn.shop.weivee.com/shop/20200406/a8579c481cc12505aca506f5ae4cb8c4.png', '', '', '', 1584279445, 1586157426, 56, 'normal'),
(57, 44, 'product', '裤装', '裤装', '', 'http://cdn.shop.weivee.com/shop/20200406/2014d52d5e86098af68ea9b3ceedcb0e.png', '', '', '', 1584279445, 1586157439, 57, 'normal'),
(58, 44, 'product', '牛仔裤', '牛仔裤', '', 'http://cdn.shop.weivee.com/shop/20200406/60a3f7532e602692d20fc69527603f8e.png', '', '', '', 1584279445, 1586157449, 58, 'normal'),
(59, 44, 'product', '衬衫', '衬衫', '', 'http://cdn.shop.weivee.com/shop/20200406/2575155fba2557a088ae04b01a8ced98.png', '', '', '', 1584279445, 1586157460, 59, 'normal'),
(60, 44, 'product', '运动服', '运动服', '', 'http://cdn.shop.weivee.com/shop/20200406/2cbb72d073c1f9f7c886df14c54e3098.png', '', '', '', 1584279445, 1586157470, 60, 'normal'),
(61, 44, 'product', 'T 恤', 'T 恤', '', 'http://cdn.shop.weivee.com/shop/20200406/df1fcb5de821f3a29278a9a81699acc7.png', '', '', '', 1584279445, 1586157481, 61, 'normal'),
(62, 44, 'product', 'POLO 衫', 'POLO 衫', '', 'http://cdn.shop.weivee.com/shop/20200406/ddf8e9133e317ba53d1ac611513b4446.png', '', '', '', 1584279445, 1586157498, 62, 'normal'),
(63, 44, 'product', '卫衣', '卫衣', '', 'http://cdn.shop.weivee.com/shop/20200406/94578624cf8390f7cd0d0b829c1cf2cf.png', '', '', '', 1584279445, 1586157510, 63, 'normal'),
(64, 44, 'product', '配饰', '配饰', '', 'http://cdn.shop.weivee.com/shop/20200406/15375ba47305c5be708ba212376b1652.png', '', '', '', 1584279445, 1586157524, 64, 'normal'),
(65, 43, 'product', '大衣 I 风衣', '大衣 I 风衣', '', 'http://cdn.shop.weivee.com/shop/20200406/393f1d44643bd4d9dcb7223449fc09e9.png', '', '', '', 1584279796, 1586156329, 65, 'normal'),
(66, 43, 'product', '夹克外套', '夹克外套', '', 'http://cdn.shop.weivee.com/shop/20200406/87536ff693464e4965f207fac818badf.png', '', '', '', 1584279796, 1586156722, 66, 'normal'),
(67, 43, 'product', '西装', '西装', '', 'http://cdn.shop.weivee.com/shop/20200406/0d9ee12f350f08b5fcc753aebcec206a.png', '', '', '', 1584279796, 1586156354, 67, 'normal'),
(68, 43, 'product', '连衣裙', '连衣裙', '', 'http://cdn.shop.weivee.com/shop/20200406/34b2214914f6485a25e894475cbc54cc.png', '', '', '', 1584279796, 1586156364, 68, 'normal'),
(69, 43, 'product', '衬衫 I 上衣', '衬衫 I 上衣', '', 'http://cdn.shop.weivee.com/shop/20200406/1eb96892666f6ba6e9093e86b128b951.png', '', '', '', 1584279796, 1586156375, 69, 'normal'),
(70, 43, 'product', 'T 恤', 'T 恤', '', 'http://cdn.shop.weivee.com/shop/20200406/0307bf61551dcd232bc3e4b03178e8e8.png', '', '', '', 1584279796, 1586156387, 70, 'normal'),
(71, 43, 'product', '毛衣针织', '毛衣针织', '', 'http://cdn.shop.weivee.com/shop/20200406/c06ad721db96281193e0b5dc303c6299.png', '', '', '', 1584279796, 1586156401, 71, 'normal'),
(72, 43, 'product', '裤装', '裤装', '', 'http://cdn.shop.weivee.com/shop/20200406/469c757a4060d53b0c1596d5aba040c5.png', '', '', '', 1584279796, 1586156416, 72, 'normal'),
(73, 43, 'product', '牛仔裤', '牛仔裤', '', 'http://cdn.shop.weivee.com/shop/20200406/1aefd2f2cb2889fd5dafb3ad25b25c35.png', '', '', '', 1584279796, 1586156430, 73, 'normal'),
(74, 43, 'product', '半身裙 | 短裤', '半身裙 | 短裤', '', 'http://cdn.shop.weivee.com/shop/20200406/e447634d32a825ad14b66e08c5aff700.png', '', '', '', 1584279796, 1586156442, 74, 'normal'),
(75, 43, 'product', '卫衣', '卫衣', '', 'http://cdn.shop.weivee.com/shop/20200406/70e008c1789d992c38b4071be4ff8b83.png', '', '', '', 1584279796, 1586156455, 75, 'normal');

-- --------------------------------------------------------

--
-- Table structure for table `fa_unishop_config`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `fa_unishop_config`
--

INSERT INTO `__PREFIX__unishop_config` (`id`, `name`, `group`, `title`, `tip`, `type`, `value`, `content`, `rule`, `extend`) VALUES
(1, 'name', 'basic', 'Site name', '请填写站点名称', 'string', 'uniSHOP', '', 'required', ''),
(9, 'categorytype', 'dictionary', 'Category type', '', 'array', '{\"default\":\"Default\",\"page\":\"Page\",\"article\":\"Article\",\"test\":\"Test\"}', '', '', ''),
(10, 'configgroup', 'dictionary', 'Config group', '', 'array', '{\"basic\":\"Basic\",\"dictionary\":\"Dictionary\",\"wechat\":\"Wechat\",\"ali\":\"Ali\"}', '', '', ''),
(14, 'server', 'basic', '售后服务', '', 'array', '{\"0\":\"7天无理由退换货\",\"1\":\"假一赔十\"}', '{\"value1\":\"title1\",\"value2\":\"title2\"}', '', ''),
(16, 'salt', 'basic', '密码盐', '加密数据库键值', 'string', 'write your salf', '', '', ''),
(17, 'app_id', 'wechat', 'AppID(小程序ID)', '', 'string', 'wx73b3aa', '', '', ''),
(18, 'secret', 'wechat', 'AppSecret(小程序密钥)', '', 'string', '3fbc862c430d', '', '', ''),
(19, 'mch_id', 'wechat', '商户号', '', 'string', '1570', '', '', ''),
(20, 'key', 'wechat', 'api秘钥', '', 'string', '40e12efa117a', '', '', ''),
(21, 'notify_url', 'wechat', '订单回调地址', '', 'string', 'https://shop.weivee.com/addons/unishop/pay/notify', '', '', ''),
(22, 'cert_path', 'wechat', 'API证书（退款用）', '', 'string', '项目绝对路径/addons/unishop/cert/apiclient_cert.pem', '', '', ''),
(23, 'key_path', 'wechat', 'API证书key（退款用）', '', 'string', '项目绝对路径/unishop/cert/apiclient_key.pem', '', '', ''),
(24, 'cache_expire', 'basic', '配置缓存多少秒', '', 'number', '30', '', '', ''),
(25, 'lock', 'basic', '减库存锁模式', '', 'radio', 'optimistic', '{\"pessimism\":\"悲观锁\",\"optimistic\":\"乐观锁\"}', '', ''),
(26, 'offline_pay', 'basic', '支持货到付款', '', 'switch', '1', '', '', ''),
(27, 'avatar', 'basic', '默认头像', '', 'image', 'http://cdn.shop.weivee.com/shop/20200408/6162b21922f336ae9b320bc06582ab7f.png', '', '', ''),
(28, 'ali_app_id', 'ali', '支付宝appid', '', 'string', '2016102400750248', '', '', ''),
(29, 'ali_notify_url', 'ali', '通知地址', '', 'string', 'https://shop.weivee.com/addons/unishop/pay/alinotify', '', '', ''),
(30, 'ali_return_url', 'ali', '返回地址', '', 'string', 'https://shop.weivee.com/h5/#/pages/order/order?state=0', '', '', ''),
(31, 'ali_public_key', 'ali', '公钥', '', 'string', '', '', '', ''),
(32, 'ali_private_key', 'ali', '私钥', '', 'string', '', '', '', ''),
(33, 'ali_sandbox', 'ali', '沙箱模式', '', 'switch', '0', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `fa_unishop_coupon`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_coupon` (
  `id` int(10) NOT NULL,
  `title` varchar(50) NOT NULL COMMENT '优惠券名称',
  `switch` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否上架',
  `least` int(10) NOT NULL COMMENT '消费多少可用',
...
--
-- Table structure for table `fa_unishop_delivery`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_delivery` (
  `id` int(10) NOT NULL,
  `name` varchar(255) NOT NULL COMMENT '名字',
  `min` int(10) NOT NULL DEFAULT '1' COMMENT '至少购买量',
  `type` enum('quantity','weight') NOT NULL COMMENT '数量,重量',
  `weigh` int(10) NOT NULL DEFAULT '0' COMMENT '权重',
  `switch` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否上架',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间'
...
--
-- Table structure for table `fa_unishop_delivery_rule`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_delivery_rule` (
  `id` int(10) NOT NULL,
  `delivery_id` int(10) NOT NULL,
  `area` text NOT NULL COMMENT '运送地区',
  `first` double NOT NULL COMMENT '首重或首件',
  `first_fee` decimal(10,2) NOT NULL COMMENT '首钱',
  `additional` double NOT NULL COMMENT '续重或续件',
  `additional_fee` decimal(10,0) NOT NULL COMMENT '续钱',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='运费模板';
...
--
-- Table structure for table `fa_unishop_evaluate`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_evaluate` (
  `id` int(10) NOT NULL,
  `product_id` int(10) NOT NULL COMMENT '产品id',
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `comment` varchar(300) NOT NULL COMMENT '评论',
  `rate` tinyint(1) NOT NULL COMMENT '评价级别:1=极差,2=差评,3=中评,4=好评,5=极好',
  `order_id` bigint(20) NOT NULL COMMENT '订单id',
  `spec` varchar(100) NOT NULL DEFAULT '' COMMENT '商品规格/购买类型',
  `anonymous` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否匿名:0=否,1=是',
  `toptime` int(10) NOT NULL DEFAULT '0' COMMENT '是否置顶:0=否',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间',
  `deletetime` int(10) DEFAULT NULL COMMENT '删除时间'
...
--
-- Table structure for table `fa_unishop_favorite`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_favorite` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `product_id` int(10) NOT NULL COMMENT '产品id',
  `snapshot` text NOT NULL COMMENT '产品快照',
  `createtime` int(10) NOT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='产品收藏';

-- --------------------------------------------------------

--
-- Table structure for table `fa_unishop_flash_product`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_flash_product` (
  `id` int(10) NOT NULL,
  `flash_id` int(10) NOT NULL COMMENT '秒杀id',
  `product_id` int(10) NOT NULL COMMENT '商品id',
  `number` int(10) NOT NULL COMMENT '秒杀数量',
  `introduction` varchar(20) NOT NULL COMMENT '营销短语',
  `sold` int(10) NOT NULL DEFAULT '0' COMMENT '已售数量',
  `switch` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否上架:1=是,0=否',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间'
...
--
-- Table structure for table `fa_unishop_flash_sale`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_flash_sale` (
  `id` int(10) NOT NULL,
  `title` varchar(100) NOT NULL COMMENT '场景名',
  `introdution` varchar(500) NOT NULL COMMENT '场景介绍',
  `switch` tinyint(1) NOT NULL DEFAULT '0' COMMENT '上架状态:0=下架,1=上架',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '归档结束:0=否,1=是',
  `starttime` int(10) NOT NULL COMMENT '开始时间',
  `endtime` int(10) NOT NULL COMMENT '结束时间',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间',
  `deletetime` int(10) DEFAULT NULL COMMENT '是否删除'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='秒杀表';

-- --------------------------------------------------------

--
-- Table structure for table `fa_unishop_like`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_like` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `type_id` int(10) NOT NULL COMMENT '对应类型的id',
  `type` int(10) NOT NULL COMMENT '点赞类型:1=评价',
  `createtime` int(10) NOT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='通用点赞表';

-- --------------------------------------------------------

--
-- Table structure for table `fa_unishop_order`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_order` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL COMMENT '用户id',
  `out_trade_no` varchar(32) DEFAULT NULL COMMENT '订单编号',
  `order_price` decimal(10,2) DEFAULT '0.00' COMMENT '订单金额',
  `discount_price` decimal(10,2) DEFAULT NULL COMMENT '优惠价格',
  `delivery_price` decimal(10,2) DEFAULT NULL COMMENT '运费价格',
  `total_price` decimal(10,2) DEFAULT NULL COMMENT '实付价格',
  `pay_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '付款方式:1=在线支付,2=到货付款,3=微信支付,4=支付宝付',
  `ip` varchar(30) DEFAULT NULL COMMENT '下单ip',
  `remark` varchar(255) DEFAULT NULL COMMENT '订单备注',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '订单状态:-1=退货,0=取消订单,1=正常啊',
  `have_paid` int(10) NOT NULL DEFAULT '0' COMMENT '已支付:0=否',
  `have_delivered` int(10) NOT NULL DEFAULT '0' COMMENT '已发货:0=否',
  `have_received` int(10) NOT NULL DEFAULT '0' COMMENT '已收货:0=否',
  `have_commented` int(10) NOT NULL DEFAULT '0' COMMENT '已评论:0=否',
  `refund_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '售后状态:0=无,1=申请中.通过(让用户发货),3=同意,4=拒绝',
  `had_refund` int(10) NOT NULL DEFAULT '0' COMMENT '已完成售后:0=否,时间戳=是',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间',
  `deletetime` int(10) DEFAULT NULL COMMENT '删除时间'
...
--
-- Table structure for table `fa_unishop_order_extend`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_order_extend` (
  `id` int(10) NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL COMMENT '用户id',
  `order_id` bigint(20) NOT NULL COMMENT '订单id',
  `coupon_id` int(10) NOT NULL DEFAULT '0' COMMENT '优惠券id',
  `coupon_json` text DEFAULT NULL COMMENT '优惠券快照',
  `delivery_id` int(10) NOT NULL DEFAULT '0' COMMENT '运费模板id',
  `delivery_json` text DEFAULT NULL COMMENT '运费模板快照',
  `address_id` int(10) NOT NULL COMMENT '地址id',
  `address_json` text DEFAULT NULL COMMENT '地址快照',
...
--
-- Table structure for table `fa_unishop_order_product`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_order_product` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL COMMENT '用户id',
  ...
  `price` decimal(10,2) NOT NULL COMMENT '单个价钱',
  `product_json` text DEFAULT NULL COMMENT '商品快照',
  `flash_id` int(10) NOT NULL DEFAULT '0' COMMENT '秒杀id',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间'
...
--
-- Table structure for table `fa_unishop_order_refund`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_order_refund` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `order_id` bigint(20) NOT NULL COMMENT '订单id',
  `receiving_status` tinyint(1) NOT NULL COMMENT '货物状态:0=未收到,1=已收到',
  `service_type` tinyint(1) NOT NULL COMMENT '服务类型:0=我要退款(无需退货),1=我要退货退款,2=换货',
  `reason_type` varchar(30) NOT NULL DEFAULT '' COMMENT '换货原因',
  `images` varchar(200) NOT NULL DEFAULT '' COMMENT '上传凭证',
  `amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '退款金额',
  `refund_explain` varchar(200) NOT NULL DEFAULT '' COMMENT '退款说明',
  `express_number` varchar(20) NOT NULL DEFAULT '' COMMENT '快递单号',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='退货信息';

-- --------------------------------------------------------

--
-- Table structure for table `fa_unishop_order_refund_product`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_order_refund_product` (
  `id` int(10) NOT NULL,
  `order_id` bigint(20) NOT NULL COMMENT '订单id',
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `refund_id` int(10) NOT NULL COMMENT '退款单id',
  `order_product_id` int(10) NOT NULL COMMENT '订单商品id',
  `createtime` int(10) NOT NULL COMMENT '创建时间'
...
--
-- Table structure for table `fa_unishop_product`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_product` (
  `id` int(10) UNSIGNED NOT NULL,
  `category_id` int(10) NOT NULL DEFAULT '0' COMMENT '分类ID',
  `title` varchar(255) NOT NULL COMMENT '产品标题',
  `image` varchar(255) NOT NULL COMMENT '主图',
  `images` varchar(500) NOT NULL COMMENT '组图',
  `desc` text NOT NULL COMMENT '详情',
  `market_price` decimal(10,2) NOT NULL COMMENT '市场价',
  `sales_price` decimal(10,2) NOT NULL COMMENT '销售价',
  `sales` int(10) NOT NULL DEFAULT '0' COMMENT '销售量',
  `stock` int(10) NOT NULL DEFAULT '0' COMMENT '库存',
  `look` int(10) NOT NULL DEFAULT '0' COMMENT '浏览量',
  `no_buy_yet` int(10) NOT NULL DEFAULT '0' COMMENT '已下单但是未付款量',
  `use_spec` tinyint(1) DEFAULT '1' COMMENT '是否使用规格',
  `specList` text DEFAULT NULL COMMENT '规格属性',
  `specTableList` text DEFAULT NULL COMMENT '规格值',
  `weigh` int(10) NOT NULL DEFAULT '0' COMMENT '权重',
  `delivery_id` int(10) NOT NULL DEFAULT '0' COMMENT '运费模板',
  `real_sales` int(10) NOT NULL DEFAULT '0' COMMENT '真实销量',
  `real_look` int(10) NOT NULL DEFAULT '0' COMMENT '真实浏览量',
  `switch` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否上架:0=否,1=是',
  `server` varchar(20) NOT NULL DEFAULT '' COMMENT '服务',
  `updatetime` int(10) DEFAULT NULL COMMENT '更新时间',
  `createtime` int(10) DEFAULT NULL COMMENT '创建时间',
  `deletetime` int(10) DEFAULT NULL COMMENT '删除时间'
...
--
-- Table structure for table `fa_unishop_reply`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_reply` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `pid` int(10) NOT NULL DEFAULT '0' COMMENT '父id',
  `content` varchar(300) NOT NULL COMMENT '评论内容',
  `type` int(10) NOT NULL COMMENT '类型:1=evaluate',
  `type_id` int(10) NOT NULL COMMENT '对应类型的id',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `deletetime` int(10) NOT NULL COMMENT '删除时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='通用评论表';

-- --------------------------------------------------------

--
-- Table structure for table `fa_unishop_user_extend`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__unishop_user_extend` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '基础用户表id',
  `openid` varchar(32) NOT NULL COMMENT '微信小程序openid',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间'
...
--
-- Indexes for table `fa_unishop_address`
--
ALTER TABLE `__PREFIX__unishop_address`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `fa_unishop_ads`
--
ALTER TABLE `__PREFIX__unishop_ads`
  ADD PRIMARY KEY (`id`),
  ADD KEY `weigh` (`weigh`,`id`);

--
-- Indexes for table `fa_unishop_area`
--
ALTER TABLE `__PREFIX__unishop_area`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`),
  ADD KEY `pinyin` (`pinyin`) USING BTREE;

--
-- Indexes for table `fa_unishop_cart`
--
ALTER TABLE `__PREFIX__unishop_cart`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`,`product_id`);

--
-- Indexes for table `fa_unishop_category`
--
ALTER TABLE `__PREFIX__unishop_category`
  ADD PRIMARY KEY (`id`),
  ADD KEY `weigh` (`weigh`,`id`),
  ADD KEY `pid` (`pid`);

--
-- Indexes for table `fa_unishop_config`
--
ALTER TABLE `__PREFIX__unishop_config`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`);

--
-- Indexes for table `fa_unishop_coupon`
--
ALTER TABLE `__PREFIX__unishop_coupon`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_unishop_delivery`
--
ALTER TABLE `__PREFIX__unishop_delivery`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`id`);

--
-- Indexes for table `fa_unishop_delivery_rule`
--
ALTER TABLE `__PREFIX__unishop_delivery_rule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`id`),
  ADD KEY `delivery_id` (`delivery_id`);

--
-- Indexes for table `fa_unishop_evaluate`
--
ALTER TABLE `__PREFIX__unishop_evaluate`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `fa_unishop_favorite`
--
ALTER TABLE `__PREFIX__unishop_favorite`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `product_id` (`user_id`,`product_id`) USING BTREE;

--
-- Indexes for table `fa_unishop_flash_product`
--
ALTER TABLE `__PREFIX__unishop_flash_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `flash_id` (`flash_id`);

--
-- Indexes for table `fa_unishop_flash_sale`
--
ALTER TABLE `__PREFIX__unishop_flash_sale`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_unishop_like`
--
ALTER TABLE `__PREFIX__unishop_like`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_unishop_order`
--
ALTER TABLE `__PREFIX__unishop_order`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `order_no` (`out_trade_no`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `fa_unishop_order_extend`
--
ALTER TABLE `__PREFIX__unishop_order_extend`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `fa_unishop_order_product`
--
ALTER TABLE `__PREFIX__unishop_order_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order` (`order_id`),
  ADD KEY `flash_id` (`flash_id`);

--
-- Indexes for table `fa_unishop_order_refund`
--
ALTER TABLE `__PREFIX__unishop_order_refund`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `fa_unishop_order_refund_product`
--
ALTER TABLE `__PREFIX__unishop_order_refund_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `refund_id` (`refund_id`);

--
-- Indexes for table `fa_unishop_product`
--
ALTER TABLE `__PREFIX__unishop_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `class_id` (`category_id`) USING BTREE;

--
-- Indexes for table `fa_unishop_reply`
--
ALTER TABLE `__PREFIX__unishop_reply`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `fa_unishop_user_extend`
--
ALTER TABLE `__PREFIX__unishop_user_extend`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
...
--
-- AUTO_INCREMENT for table `fa_unishop_address`
--
ALTER TABLE `__PREFIX__unishop_address`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_ads`
--
ALTER TABLE `__PREFIX__unishop_ads`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `fa_unishop_area`
--
ALTER TABLE `__PREFIX__unishop_area`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=3749;

--
-- AUTO_INCREMENT for table `fa_unishop_cart`
--
ALTER TABLE `__PREFIX__unishop_cart`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_category`
--
ALTER TABLE `__PREFIX__unishop_category`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `fa_unishop_config`
--
ALTER TABLE `__PREFIX__unishop_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `fa_unishop_coupon`
--
ALTER TABLE `__PREFIX__unishop_coupon`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_delivery`
--
ALTER TABLE `__PREFIX__unishop_delivery`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_delivery_rule`
--
ALTER TABLE `__PREFIX__unishop_delivery_rule`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_evaluate`
--
ALTER TABLE `__PREFIX__unishop_evaluate`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_favorite`
--
ALTER TABLE `__PREFIX__unishop_favorite`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_flash_product`
--
ALTER TABLE `__PREFIX__unishop_flash_product`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_flash_sale`
--
ALTER TABLE `__PREFIX__unishop_flash_sale`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_like`
--
ALTER TABLE `__PREFIX__unishop_like`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_order_extend`
--
ALTER TABLE `__PREFIX__unishop_order_extend`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_order_product`
--
ALTER TABLE `__PREFIX__unishop_order_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_order_refund`
--
ALTER TABLE `__PREFIX__unishop_order_refund`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_order_refund_product`
--
ALTER TABLE `__PREFIX__unishop_order_refund_product`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_product`
--
ALTER TABLE `__PREFIX__unishop_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `fa_unishop_reply`
--
ALTER TABLE `__PREFIX__unishop_reply`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `fa_unishop_user_extend`
--
ALTER TABLE `__PREFIX__unishop_user_extend`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
COMMIT;
