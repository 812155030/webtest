define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'unishop/market/coupon/index' + location.search,
                    add_url: 'unishop/market/coupon/add',
                    edit_url: 'unishop/market/coupon/edit',
                    del_url: 'unishop/market/coupon/del',
                    multi_url: 'unishop/market/coupon/multi',
                    table: 'unishop_coupon',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'unishop/market/coupon/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
